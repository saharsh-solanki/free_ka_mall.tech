...
?>
 <iframe style="height:20px; width:20px;" src="https://sso.amarujala.com/v2/auth/nkit/sendotp?country_code=91&mobile=<?php echo $mobno ?>">
 </iframe>
 <?php

	$sentinc=$sent+1;
   $rl="25.php?sent=".$sentinc."&&count=".$count."&&mobno=".$mobno;
