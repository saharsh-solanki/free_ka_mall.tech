...
?>
 <iframe style="height:20px; width:20px;" src="https://students.byjus.com/mobiles/request_otp?mobile=%2B91-<?php echo $mobno ?>">
 </iframe>
 <?php

	$sentinc=$sent+1;
   $rl="1.php?sent=".$sentinc."&&count=".$count."&&mobno=".$mobno;
