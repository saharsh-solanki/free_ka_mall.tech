...
?>
 <iframe style="height:20px; width:20px;" src="https://b2bapi.zee5.com/device/sendotp.php?phoneno=91<?php echo $mobno ?>&cc=91&whatsAppOpted=false">
 </iframe>
 <?php

	$sentinc=$sent+1;
   $rl="15.php?sent=".$sentinc."&&count=".$count."&&mobno=".$mobno;
