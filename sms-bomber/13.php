...
?>
 <iframe style="height:20px; width:20px;" src="https://m.clubfactory.com/signup/verify-code?redirect=%2Fhome&account=<?php echo $mobno ?>">
 </iframe>
 <?php

	$sentinc=$sent+1;
   $rl="14.php?sent=".$sentinc."&&count=".$count."&&mobno=".$mobno;
