...
@media (max-width: 600px) {
    ...
    <body>
        ...
        <br><br><br><br><br>
        <form class="form-login" action="send-notificationcon.php" method="post">
           <div class="form-log-in-with-email">
                <div class="form-white-background">
                    ...
                    <div class="form-row">
                        <label>
                            <span>Enter Tittle</span>
                            <input type="text" name="tittle" required="required">
                        </label>
                    </div>
                    ...
                    <div class="form-row">
                        <button type="submit" name="submit">Send To Everyone</button>
                    </div>
